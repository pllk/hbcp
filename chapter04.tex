...
Algorithms 1 and 3 are equal and Algorithm 3 is the fastest. which is intuitive as the time complexity of Algorithm 1 and Algorithm 3 are O(nlogn) which is bigger than O(n) when n tends to be very large(like $10^7$).
